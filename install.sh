...
echo ""
echo "Maestro.app has been installed to: $DEST"
echo "Configured for worktree: $MAESTRO_WORKTREE_DIR"
echo ""
echo "Double-click Maestro.app to launch!"
echo "Logs will be written to: ${LOG_FILE:-$HOME/Desktop/MaestroPreview.log}"
